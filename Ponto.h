...
public:
    /**
     * @brief Ponto e o construtor padrao da classe
     */
    Ponto();
    /**
     * @brief ~Ponto e o destrutor padrao da classe
     */
    ~Ponto();
    /**
    ...
    float getY();
    /**
     * @brief setXY e responsavel por sobrescreve simultaneamente valores de x e y do par ordenado
     * @param px novo valor de x
     * @param py novo valor de y
     */
