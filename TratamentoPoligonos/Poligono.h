...
public:
    /**
     * @brief Poligono eh o construtor padrao da classe
     *
     * Nele eh feita a alocacao dinamica do vetor de 100 objetos da classe Ponto, que sao usados para os vertices do poligono
     */
    Poligono();
    /**
     * @brief ~Poligono destrutor padrao da classe
     *
     * No destrutor eh realizada a liberacao da memoria alocada para os 100 objetos da classe Ponto
     */
    ~Poligono();
    /**
     * @brief Vertices guarda valores das coordenadas do ponto p1 no vetor de Ponto cujo indice eh o numero de vertices atual do poligono
    ...
    void imprime();
    /**
     * @brief centroMassa calcula o ponto que eh o centro de massa do poligono
